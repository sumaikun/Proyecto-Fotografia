            ...
            <div class="col-md-12">
              <div class="box box-primary">
                ...
                <div class="box-body pad table-responsive">
                  <form method="POST" action="/profile/cover" accept-charset="UTF-8" enctype="multipart/form-data">
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="box">
                ...
                <div class="box-body table-responsive pad">                 
                   <form method="POST" action="/profile/info" accept-charset="UTF-8" enctype="multipart/form-data">
                      <input type="hidden" name="_token" value="{{ csrf_token() }}" id="token">
                       <div class="form-group">
                         {!!Form::label('Titulo')!!}
              ...
              <div class="box">
                ...
                <div class="box-body">
                      <form method="POST" action="/profile/pic1" accept-charset="UTF-8" enctype="multipart/form-data">
              ...
              <div class="box">
                ...
                <div class="box-body">
                  <form method="POST" action="/profile/audio" accept-charset="UTF-8" enctype="multipart/form-data">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}" id="token">
                        <div class="form-group">
                          {!!Form::label('Titulo')!!}
                          {!!Form::text('titulo',null,['id'=>'titulo','class'=>'form-control','maxlength'=>'25','required'])!!}
            ...
            <div class="col-md-6">
              ...
              <div class="box">
                ...
                <div class="box-body">
                  <form method="POST" action="/profile/info2" accept-charset="UTF-8" enctype="multipart/form-data">
                      <input type="hidden" name="_token" value="{{ csrf_token() }}" id="token">                  
                       <div class="form-group">
                      {!!Form::label('Titulo')!!}
              ...
              <div class="box">
                <div class="box-header">
                  ...
                  <div class="box-body table-responsive pad">
                  <form method="POST" action="/profile/pic2" accept-charset="UTF-8" enctype="multipart/form-data">
                      <input type="hidden" name="_token" value="{{ csrf_token() }}" id="token">
                          <div class="form-group">
                            {!!Form::label('Titulo')!!}
                            {!!Form::text('titulo',null,['id'=>'titulo','class'=>'form-control','maxlength'=>'25','required'])!!}
